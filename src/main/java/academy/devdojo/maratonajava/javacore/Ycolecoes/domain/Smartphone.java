...
public class Smartphone {
    ...
    //Simetrico: para x e y diferentess de null, se x.equals(y) == true logo, y.equals(x) ==true
    //Transitividade: para x,y,z diferentess de null, se x.equals(y) == true, e x.equals(z) == true
